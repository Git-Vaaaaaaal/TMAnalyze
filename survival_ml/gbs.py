...
os.makedirs("out_gb", exist_ok=True)
log_path = "logs_gb_survival.txt"
results  = []
...
for marker in marker_list:
    for encoder in encoder_list:
        ...
        if km_data:
            ...
            ax.legend()
            ax.grid(True)
            fig.savefig(f"out_gb/{marker}_{encoder}_km.png", dpi=150, bbox_inches="tight")
            plt.close(fig)

csv_path = "out_gb/results.csv"
